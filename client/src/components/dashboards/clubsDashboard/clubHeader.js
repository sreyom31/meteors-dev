    ...
    return (
        <div className={"container mx-auto py-2 px-8 rounded-xl grid grid-cols-3 items-center"}>
            ...
            <ul className={"list-none flex justify-center space-x-8"}>
                ...
                <li><a href={"/dashboard"} className={"pb-1 px-3 border-b border-b-transparent text-white duration-300 hover:border-b-orange-400 hover:text-orange-400"}>Dashboard</a></li>
            </ul>
