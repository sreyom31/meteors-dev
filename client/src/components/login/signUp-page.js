...
export default () => {
    return (
        <div className={"bg-slate-300 w-screen h-screen lg:flex lg:flex-row lg:items-center"}>
            <div className={"container h-4/5 mx-auto lg:flex lg:items-center lg:items-stretch"}>
                ...
                <div className={"w-4/5 absolute top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 py-10 rounded-3xl lg:relative " +
                    ...
                    <div className={'py-5 px-5 rounded-full bg-blue-400 mb-5'}><i className="fa-solid fa-user-plus text-4xl text-gray-100"></i></div>
